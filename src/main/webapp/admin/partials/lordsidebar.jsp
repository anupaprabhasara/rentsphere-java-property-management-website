...
<aside class="w-60 hidden md:flex flex-col bg-slate-800 border-r border-slate-700 shadow-md fixed h-full">
    ...
    <nav id="sidebarNav" class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
        <a href="${pageContext.request.contextPath}/admin/my-property" class="flex items-center p-3 rounded hover:bg-blue-600/20 transition">
            <i class="fas fa-building mr-3"></i> My Properties
        </a>
    </nav>
